# Contributing to NGSI Go

Thanks for checking out the NGSI Go Project. We're excited to hear and learn from you. We've put together the following
...
-   If you open a pull request, you must sign the
    [Individual Contributor License Agreement](https://github.com/lets-fiware/ngsi-go/blob/master/ngsi-go-individual-cla.pdf) by
...
If you'd like to contribute, start by searching through the [issues](https://github.com/lets-fiware/ngsi-go/issues) and
[pull requests](https://github.com/lets-fiware/ngsi-go/pulls) to see whether someone else has raised a similar idea or
question.
...
[Issues](https://github.com/lets-fiware/ngsi-go/issues) and [Pull Requests](https://github.com/lets-fiware/ngsi-go/pulls)
